    ...
    this._list = [
      new Order(
          new Product('Digital Display Bracelet Watch',
              'assets/img/watch6.webp', 80, 63.98, 200, 2554, 3.1, 10.5),
          'RB4551532214564',
          OrderState.shipped),
      new Order(
          new Product('Spring Hand Grip Finger Strength',
              'assets/img/sport5.webp', 10, 12.36, 153, 166, 4.2, 11.5),
          'CH4561454563156',
      ...
      new Order(
          ...
          OrderState.unpaid),
      new Order(
          new Product('Robe pin up', 'assets/img/home2.webp', 10, 12.36, 153,
              166, 4.2, 11.5),
          'CH456124566652',
          OrderState.shipped),
    ];
